...
class JointAnglePositionPublisher(Node):
    def __init__(self):
        ...
        self.joint_1_final_angle = math.radians(90)
        self.joint_2_final_angle = math.radians(70)
        self.joint_3_final_angle = math.radians(35)
        self.joint_4_final_angle = math.radians(90)
    ...
    def publish_interpolation_trajectory(self):
        ...
        print(f"Joint 4: {round(math.degrees(self.new_joint_3_value), 2)} °")
